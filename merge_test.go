...
func TestMergeP(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run("", func(t *testing.T) {
			...
			res := MergeP(rules, LiteralEqual(nilLogger), nilLogger)
			assert.Equal(t, tt.want, res)
		})
	}
}
...
func TestMergeR(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run("", func(t *testing.T) {
			...
			res := MergeR(rules, LiteralEqual(nilLogger), nilLogger)
			assert.Equal(t, tt.want, res)
		})
	}
}
...
func TestMergeS(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run("", func(t *testing.T) {
			...
			res := MergeS(rules, LiteralEqual(nilLogger), nilLogger)
			assert.Equal(t, tt.want, res)
		})
	}
}
...
func TestMergePR(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run("", func(t *testing.T) {
			...
			res := MergePR(rules, LiteralEqual(nilLogger), nilLogger)
			assert.Equal(t, tt.want, res)
		})
	}
}
...
func TestMergePS(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run("", func(t *testing.T) {
			...
			res := MergePS(rules, LiteralEqual(nilLogger), nilLogger)
			assert.Equal(t, tt.want, res)
		})
	}
}
...
func TestMergeRS(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run("", func(t *testing.T) {
			...
			res := MergeRS(rules, LiteralEqual(nilLogger), nilLogger)
			assert.Equal(t, tt.want, res)
		})
	}
}
...
func TestMergeMisc(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run("", func(t *testing.T) {
			...
			res := MergeMisc(rules, DummyEqual(nilLogger), nilLogger)
			assert.Equal(t, tt.want, res)
		})
	}
}
...
func TestGroupFactor(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run("", func(t *testing.T) {
			...
			rules = SetIDs(rules)
			res := GroupFactor(rules, tt.args.ff, nilLogger)
			SortPRS(res)
			assert.Equal(t, tt.want, res)
		})
	}
...
func TestSynonymFactor(t *testing.T) {
	...
	tests := []struct {
		...
		{args: args{f: "./data/tests/test5.csv", ff: "./data/tests/syn1.json"}, want: []Rule{{pre: []string{}, root: []string{"TEST1", "TEST2", "I want to know what"}, suf: []string{}, isPublic: false, id: 2}, {pre: []string{""}, root: []string{"I don't have an online account"}, suf: []string{""}, isPublic: true, id: 0}}},
		{args: args{f: "./data/tests/test5.csv", ff: "./data/tests/syn2.json"}, want: []Rule{{pre: []string{}, root: []string{"TEST5", "TEST6", "I want to know what"}, suf: []string{}, isPublic: false, id: 2}, {pre: []string{}, root: []string{"TEST7", "My bill"}, suf: []string{}, isPublic: false, id: 3}, {pre: []string{}, root: []string{"my bill"}, suf: []string{}, isPublic: false, id: 4}, {pre: []string{""}, root: []string{"I don't have an online account"}, suf: []string{""}, isPublic: true, id: 0}}},
		...
		{args: args{f: "./data/tests/test6.csv", ff: "./data/tests/syn1.json"}, want: []Rule{{pre: []string{}, root: []string{"TEST1", "TEST2", "I want to know what"}, suf: []string{}, isPublic: false, id: 12}, {pre: []string{""}, root: []string{"I don't have an online account"}, suf: []string{""}, isPublic: true, id: 0}, {pre: []string{""}, root: []string{"I don't understand you"}, suf: []string{""}, isPublic: true, id: 1}, {pre: []string{""}, root: []string{"I got an error message when I attempted to make a payment"}, suf: []string{""}, isPublic: true, id: 2}, {pre: []string{""}, root: []string{"I want an online accoynt"}, suf: []string{""}, isPublic: true, id: 3}, {pre: []string{""}, root: []string{"ask an agent to notify issues with my payment"}, suf: []string{""}, isPublic: true, id: 4}, {pre: []string{""}, root: []string{"can you show me information about the status of my refund ?"}, suf: []string{""}, isPublic: true, id: 5}, {pre: []string{""}, root: []string{"can you show me my invoices ?"}, suf: []string{""}, isPublic: true, id: 6}, {pre: []string{""}, root: []string{"can you tell me how I can get some bills ?"}, suf: []string{""}, isPublic: true, id: 7}, {pre: []string{""}, root: []string{"i dont want my profile"}, suf: []string{""}, isPublic: true, id: 8}, {pre: []string{""}, root: []string{"i want to know wat the email of Customer Service is"}, suf: []string{""}, isPublic: true, id: 9}, {pre: []string{""}, root: []string{"where can i leave an opinion for a service ?"}, suf: []string{""}, isPublic: true, id: 10}}},
		{args: args{f: "./data/tests/test6.csv", ff: "./data/tests/syn2.json"}, want: []Rule{{pre: []string{}, root: []string{"TEST5", "TEST6", "I want to know what"}, suf: []string{}, isPublic: false, id: 12}, {pre: []string{}, root: []string{"TEST7", "My bill"}, suf: []string{}, isPublic: false, id: 13}, {pre: []string{}, root: []string{"my bill"}, suf: []string{}, isPublic: false, id: 14}, {pre: []string{""}, root: []string{"I don't have an online account"}, suf: []string{""}, isPublic: true, id: 0}, {pre: []string{""}, root: []string{"I don't understand you"}, suf: []string{""}, isPublic: true, id: 1}, {pre: []string{""}, root: []string{"I got an error message when I attempted to make a payment"}, suf: []string{""}, isPublic: true, id: 2}, {pre: []string{""}, root: []string{"I want an online accoynt"}, suf: []string{""}, isPublic: true, id: 3}, {pre: []string{""}, root: []string{"ask an agent to notify issues with my payment"}, suf: []string{""}, isPublic: true, id: 4}, {pre: []string{""}, root: []string{"can you show me information about the status of my refund ?"}, suf: []string{""}, isPublic: true, id: 5}, {pre: []string{""}, root: []string{"can you show me my invoices ?"}, suf: []string{""}, isPublic: true, id: 6}, {pre: []string{""}, root: []string{"can you tell me how I can get some bills ?"}, suf: []string{""}, isPublic: true, id: 7}, {pre: []string{""}, root: []string{"i dont want my profile"}, suf: []string{""}, isPublic: true, id: 8}, {pre: []string{""}, root: []string{"i want to know wat the email of Customer Service is"}, suf: []string{""}, isPublic: true, id: 9}, {pre: []string{""}, root: []string{"where can i leave an opinion for a service ?"}, suf: []string{""}, isPublic: true, id: 10}}},
		...
		{args: args{f: "./data/tests/test7.csv", ff: "./data/tests/syn1.json"}, want: []Rule{{pre: []string{}, root: []string{"TEST1", "TEST2", "I want to know what"}, suf: []string{}, isPublic: false, id: 1}}},
		{args: args{f: "./data/tests/test8.csv", ff: "./data/tests/syn2.json"}, want: []Rule{{pre: []string{}, root: []string{"TEST5", "TEST6", "I want to know what"}, suf: []string{}, isPublic: false, id: 1}, {pre: []string{}, root: []string{"TEST7", "My bill"}, suf: []string{}, isPublic: false, id: 2}, {pre: []string{}, root: []string{"my bill"}, suf: []string{}, isPublic: false, id: 3}}},
		...
		{args: args{f: "./data/tests/test9.csv", ff: "./data/tests/syn1.json"}, want: []Rule{{pre: []string{}, root: []string{"TEST1", "TEST2", "I want to know what"}, suf: []string{}, isPublic: false, id: 12}, {pre: []string{""}, root: []string{"<TEST1_TEST2_I_want_t_12> the number of Customer Service is"}, suf: []string{""}, isPublic: true, id: 4}, {pre: []string{""}, root: []string{"I don't have an online account"}, suf: []string{""}, isPublic: true, id: 0}, {pre: []string{""}, root: []string{"I have a question"}, suf: []string{""}, isPublic: true, id: 1}, {pre: []string{""}, root: []string{"I ordered an item and Id like to modify my fucking order"}, suf: []string{""}, isPublic: true, id: 2}, {pre: []string{""}, root: []string{"I want to download a bill"}, suf: []string{""}, isPublic: true, id: 3}, {pre: []string{""}, root: []string{"I want to make a review for a service"}, suf: []string{""}, isPublic: true, id: 5}, {pre: []string{""}, root: []string{"how do I make changes to my shipping address ?"}, suf: []string{""}, isPublic: true, id: 6}, {pre: []string{""}, root: []string{"i get an error message when i ty to make a payment for my order"}, suf: []string{""}, isPublic: true, id: 7}, {pre: []string{""}, root: []string{"i want to request an invoice"}, suf: []string{""}, isPublic: true, id: 8}, {pre: []string{""}, root: []string{"where do i check the delivery options ?"}, suf: []string{""}, isPublic: true, id: 9}, {pre: []string{""}, root: []string{"you arent helping"}, suf: []string{""}, isPublic: true, id: 10}}},
		{args: args{f: "./data/tests/test9.csv", ff: "./data/tests/syn2.json"}, want: []Rule{{pre: []string{}, root: []string{"TEST5", "TEST6", "I want to know what"}, suf: []string{}, isPublic: false, id: 12}, {pre: []string{}, root: []string{"TEST7", "My bill"}, suf: []string{}, isPublic: false, id: 13}, {pre: []string{}, root: []string{"my bill"}, suf: []string{}, isPublic: false, id: 14}, {pre: []string{""}, root: []string{"<TEST5_TEST6_I_want_t_12> the number of Customer Service is"}, suf: []string{""}, isPublic: true, id: 4}, {pre: []string{""}, root: []string{"I don't have an online account"}, suf: []string{""}, isPublic: true, id: 0}, {pre: []string{""}, root: []string{"I have a question"}, suf: []string{""}, isPublic: true, id: 1}, {pre: []string{""}, root: []string{"I ordered an item and Id like to modify my fucking order"}, suf: []string{""}, isPublic: true, id: 2}, {pre: []string{""}, root: []string{"I want to download a bill"}, suf: []string{""}, isPublic: true, id: 3}, {pre: []string{""}, root: []string{"I want to make a review for a service"}, suf: []string{""}, isPublic: true, id: 5}, {pre: []string{""}, root: []string{"how do I make changes to my shipping address ?"}, suf: []string{""}, isPublic: true, id: 6}, {pre: []string{""}, root: []string{"i get an error message when i ty to make a payment for my order"}, suf: []string{""}, isPublic: true, id: 7}, {pre: []string{""}, root: []string{"i want to request an invoice"}, suf: []string{""}, isPublic: true, id: 8}, {pre: []string{""}, root: []string{"where do i check the delivery options ?"}, suf: []string{""}, isPublic: true, id: 9}, {pre: []string{""}, root: []string{"you arent helping"}, suf: []string{""}, isPublic: true, id: 10}}},
	...
	for _, tt := range tests {
		t.Run("", func(t *testing.T) {
			...
			rules = SetIDs(rules)
			res := SynonymFactor(rules, syn, tk, nilLogger)
			SortPRS(res)
			assert.Equal(t, tt.want, res)
		})
	}
...
func TestConstituencyFactor(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run("", func(t *testing.T) {
			...
			res := ConstituencyFactor(rules, tag, tt.args.ff, nilLogger)
			SortPRS(res)
			assert.Equal(t, tt.want, res)
		})
	}
